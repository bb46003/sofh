export default class SpecialMovesDataModel extends foundry.abstract .TypeDataModel { 
  static defineSchema() {
     const fields = foundry.data.fields; 
     const schema = {} 
     const actionFields = {};
     for (const [key, label] of Object.entries(CONFIG.SOFHCONFIG.typeOfSpecialMoves)) {
       actionFields[key] = new fields.SchemaField({ 
        label: new fields.StringField({ 
          label: "Localized Label", 
          required: true, initial: label }),
      ...
      schema.resultsChange = new fields.SchemaField({ 
        below7: new fields.HTMLField(), 
        "7to9": new fields.HTMLField(), 
        above10: new fields.HTMLField(), 
        above12: new fields.HTMLField(), 
      }) 
      schema.additionalQuestion = new fields.ArrayField( 
        new fields.SchemaField({ question: new fields.StringField()})
      );
